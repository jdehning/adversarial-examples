...
In this method a noise is created in the direction of the gradient of the loss function to maximise the value of the loss function for the right prediction in order to for another 
\begin{align*}
